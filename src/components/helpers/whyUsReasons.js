...
import lawnMowerIcon from '../images/icons/lawnmower.svg';
import heartIcon from '../images/icons/heart-icon.svg';
import chattingIcon from '../images/icons/chatting.svg';
import tapmeasure from '../images/icons/tape-measure.svg';

const whyUsReasons = [
  {
    heading: 'Expertise You Can Trust',
    text:
      "Our team of seasoned professionals brings a wealth of expertise to your doorstep. With years of experience, we've perfected the art of transforming ordinary yards into extraordinary retreats.",
    icon: userIcon,
  },
  {
